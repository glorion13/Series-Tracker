...
"C:\Program Files (x86)\Microsoft SDKs\Windows Phone\v8.0\Tools\IsolatedStorageExplorerTool\"ISETool.exe rs deviceindex:%TARGETDEVICE% !TARGETID! "testdata\IsolatedStore"